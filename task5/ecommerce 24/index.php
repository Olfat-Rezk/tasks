...
$brandsResult = $brandsModel->get()->fetch_all(MYSQLI_ASSOC);
$productModel = new Product;
$productResult = $productModel->getRecent()->fetch_all(MYSQLI_ASSOC);

$order_products = $productModel->mostOrder()->fetch_all(MYSQLI_ASSOC);
?>
    <!-- Slider Start -->
    ...
    <div class="product-area bg-image-1 pt-100 pb-95">
        <div class="container">
            <div class="row">
                <?php foreach($brandsResult AS $brand) { ?>
                    <div class="col-3">
    ...
    <div class="blog-area bg-image-1 pt-90 pb-70">
        <div class="container">
            <div class="product-top-bar section-border mb-55">
                <div class="section-title-wrap text-center">
                    <h3 class="section-title">Most Orderd</h3>
                </div>
            </div>
        </div>
        <div class="container">
