...
class User extends Model{
    private $id,$first_name,$last_name,$gender,$status,$email,$phone,$password,
    $verification_code,$email_verification_at,$created_at,$updated_at ; 
    ...
    public function setVerification_code($verification_code)
    {
     ...
     /**
     * Get the value of email_verification_at
     */ 
    public function getEmail_verification_at()
    {
        return $this->email_verification_at;
    }

    /**
     * Set the value of email_verification_at
     *
     * @return  self
     */ 
    public function setEmail_verification_at($email_verification_at)
    {
    ...
    /**
     * Get the value of email_verificatio_at
     */ 
